...
class _FakeInsertStatement_16<T extends _i4.Table, D> extends _i1.SmartFake
...
class _FakeSimpleSelectStatement_18<T extends _i4.HasResultSet, D>
...
class _FakeDeleteStatement_20<T extends _i4.Table, D> extends _i1.SmartFake
...
class MockFLauncherChannel extends _i1.Mock implements _i8.FLauncherChannel {
  ...
  @override
  _i7.Future<List<dynamic>> getApplications() => (super.noSuchMethod(
        Invocation.method(
          #getApplications,
          [],
        ),
  ...
  @override
  _i7.Future<void> openAccessibilitySettings() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i7.Future<List<dynamic>> getButtonMappings() => (super.noSuchMethod(
        Invocation.method(
          #getButtonMappings,
          [],
        ),
  ...
  @override
  _i7.Future<void> setButtonMapping(
    int? keyCode,
    String? packageName,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<void> removeButtonMapping(int? keyCode) => (super.noSuchMethod(
        Invocation.method(
          #removeButtonMapping,
          [keyCode],
        ),
  ...
  @override
  _i7.Stream<Map<dynamic, dynamic>> captureNextButton() => (super.noSuchMethod(
        Invocation.method(
          #captureNextButton,
          [],
        ),
...
class MockWallpaperService extends _i1.Mock implements _i9.WallpaperService {
  ...
  @override
  _i7.Future<void> randomFromUnsplash(String? query) => (super.noSuchMethod(
        Invocation.method(
          #randomFromUnsplash,
          [query],
        ),
  ...
  @override
  _i7.Future<void> randomFromPicsum({int? blur}) => (super.noSuchMethod(
        Invocation.method(
          #randomFromPicsum,
          [],
          {#blur: blur},
  ...
  @override
  _i7.Future<void> setFromUnsplash(_i3.Photo? photo) => (super.noSuchMethod(
        Invocation.method(
          #setFromUnsplash,
          [photo],
        ),
...
class MockSettingsService extends _i1.Mock implements _i10.SettingsService {
  ...
  @override
  _i7.Future<void> setUse24HourTimeFormat(bool? value) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i7.Future<void> setUnsplashAuthor(String? value) => (super.noSuchMethod(
        Invocation.method(
          #setUnsplashAuthor,
          [value],
        ),
...
class MockUnsplashService extends _i1.Mock implements _i3.UnsplashService {
  ...
  @override
  _i7.Future<_i3.Photo> randomPhoto(String? query) => (super.noSuchMethod(
        Invocation.method(
          #randomPhoto,
          [query],
        ),
        returnValue: _i7.Future<_i3.Photo>.value(_FakePhoto_1(
          this,
          Invocation.method(
            #randomPhoto,
            [query],
...
class MockPicsumService extends _i1.Mock implements _i14.PicsumService {
  ...
  @override
  _i7.Future<_i13.Uint8List> randomPhoto({int? blur}) => (super.noSuchMethod(
        Invocation.method(
          #randomPhoto,
          [],
          {#blur: blur},
...
class MockButtonMappingService extends _i1.Mock
  ...
  @override
  _i7.Future<void> removeMapping(int? keyCode) => (super.noSuchMethod(
        Invocation.method(
          #removeMapping,
          [keyCode],
        ),
