...
`docs/DRIFT.md` for the detailed rationale behind each change, `docs/TODO.md` for known issues and
open items, and `docs/ADR_001_Project_Scope_and_Feature_Governance.md` before proposing any new
feature — it's the gate new work gets weighed against, not just this project's history. This file is
about *working on the code* — toolchain, commands, conventions.
